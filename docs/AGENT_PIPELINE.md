...
| MACE hybrid research | `mace_polar_1m_vacuum_r2scan3c_subtractive_pilot_v1`; `scripts/mace_hybrid.py` | Approved 12-call consumed 1H4I pilot, zero new DFT. Job1200197 queued; scheduler host-memory mismatch remains unresolved and the allocation guard blocks inference with the wrong share. No measured MACE result or calibrated class yet. [Runbook](../diagnostics/mace_hybrid_20260916/RUNBOOK.md). |
