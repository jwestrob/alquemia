...
If the frozen water bond lengths/angle relax, their electronic relaxation must
also be accounted for here; DeltaE_relax above contains only rigid-water motion.
Do not count that internal-coordinate relaxation twice or assume it is zero.
