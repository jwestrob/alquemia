...
| MACE hybrid research | `mace_polar_1m_vacuum_r2scan3c_subtractive_pilot_v1`; `scripts/mace_hybrid.py` | Approved 12-call consumed 1H4I pilot, zero new DFT. Job1200207 queued with one H200/28 CPUs/200000 MiB RAM explicitly accepted by Jacob; exact-share blocker removed. No measured MACE result or calibrated class yet. [Runbook](../diagnostics/mace_hybrid_20260916/RUNBOOK.md). |
